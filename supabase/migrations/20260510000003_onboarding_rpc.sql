-- Migration to upgrade the atomic initialization function 
-- Universal Aggressive Cleanup to resolve 400 Bad Request.
-- Removed default values from function signature to force explicit parameters from the client.

DROP FUNCTION IF EXISTS public.create_new_ledger_system(text, text);
DROP FUNCTION IF EXISTS public.create_new_ledger_system(text, text, text, text, text, text);
